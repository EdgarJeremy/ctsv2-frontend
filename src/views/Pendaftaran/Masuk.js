...
export default class Masuk extends React.Component {
  ...
  _fetchRegistrations(purpose_id) {
    ...
    return this.props.models.Registration.collection({
      attributes: ['id', 'name', 'nik', 'data', 'created_at', 'purpose_id', 'step_id', 'queue_id', 'source'],
    ...
    return (
      (this.state.ready) ?
        <div className="animated fadeIn">
          ...
          />}
          <PreviewDocuments ref={ref => this.previewDocs = ref} models={this.props.biviModels} id={this.state.queue_id} source={this.state.source} />
        </div > :
        <Loadable
          spinnerSize="100px"
