...
export default class Masuk extends React.Component {
    ...
    _initialize() {
        this.props.models.authenticated.pendaftaran_last_my_track(this.state.limit, this.state.offset, this.state.searchValue, this.state.startDate, this.state.endDate, this.state.selectedTujuan).then((data) => {
            this.setState({
