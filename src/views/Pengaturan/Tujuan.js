...
import SourceListPopup from '../../components/SourceListPopup';
...
export default class Tujuan extends React.Component {
  ...
  _openSource(item) {
    this.setState({ selected: item, modalSource: true });
  }
    ...
    return (
      (this.state.ready) ?
        <div className="animated fadeIn">
                          ...
                          return (
                            <tr key={i}>
                              ...
                              <td>
                                ...
                                <button onClick={() => this._openSource(item)} type="button" className="btn btn-outline-success">
                                  <i className="fa fa-edit"></i>&nbsp;Integrasi Sumber
                                                                </button>{' '}
          ...
          {this.state.modalSource && <SourceListPopup
            {...this.props}
            open={this.state.modalSource}
            purpose={this.state.selected}
            toggle={() => this.setState({ modalSource: false })}
            onSuccess={() => {
              this.setState({ modalSource: false });
              this._initialize();
            }} />}
        </div> :
        <Loadable
